                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['pilihan'])&&$_GET['pilihan']=='npm'&&isset($_GET['id'])&&!empty($_GET['id'])) {
                                        $datas=$pelajar->RecordsByNPM($_GET['id']);
                                        ...
                                        for ($i=0; $i < count($datas) ; $i++) { 
                                            ...
                                            echo "<td><a href='proses.php?tipe=mahasiswa&aksi=1&id=".$records[$i][0]."' class='btn btn-danger'>Hapus</a></td>";
                                            echo "</tr>";
                                        }
                                    }elseif (isset($_GET['pilihan'])&&$_GET['pilihan']=='nama'&&isset($_GET['id'])&&!empty($_GET['id'])) {
                                         $datas=$pelajar->RecordsByNama($_GET['id']);
                                    ...
                                    }elseif(isset($_GET['pilihan'])&&$_GET['pilihan']=='jurusan'&&isset($_GET['id'])&&!empty($_GET['id'])){
                                        $datas=$pelajar->RecordsByJurusan($_GET['id']);
